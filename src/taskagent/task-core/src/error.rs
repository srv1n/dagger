...
pub enum TaskError {
    ...
    TaskNotFound(crate::model::TaskId),
    ...
    AgentNotFound(crate::model::AgentId),

    #[error("Agent already registered: {0}")]
    AgentAlreadyRegistered(crate::model::AgentId),
...
impl TaskError {
    ...
    pub fn suggested_retry_delay(&self) -> Option<Duration> {
        match self {
            ...
            Self::Sqlite(_) | Self::Storage(_) => Some(Duration::from_secs(2)),
...
impl From<bincode::Error> for TaskError {
...
mod tests {
    ...
    fn test_error_retryable() {
        ...
        let not_found = TaskError::TaskNotFound(123);
    ...
    fn test_retry_delays() {
        ...
        let io_err = TaskError::Io(io::Error::new(io::ErrorKind::TimedOut, "timeout"));
        assert_eq!(io_err.suggested_retry_delay(), Some(Duration::from_secs(1)));
    }
